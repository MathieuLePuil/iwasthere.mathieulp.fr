...
10. **Mise à jour du code.** `bin/deploy` enchaîne tout dans le bon ordre
    (dépendances, arrêt du worker, migrations, assets, cache, OPcache). Le détail,
    pour savoir pourquoi l'ordre compte : Le pool PHP-FPM tourne avec
