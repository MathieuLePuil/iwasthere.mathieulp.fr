...
class ProfileController extends AbstractController
{
    ...
    public function addFriend(User $targetUser, EntityManagerInterface $em, FriendRepository $friendRepo, WebPushService $push): Response
    {
        $user = $this->getUser();
    ...
    public function acceptFriend(Friend $friend, EntityManagerInterface $em, WebPushService $push): Response
    {
        $user = $this->getUser();
